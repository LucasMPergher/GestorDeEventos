...
public class EventoController {
    ...
    @FXML
    private ComboBox<String> tipoEventoCombo;
    @FXML
    private DatePicker fechaInicioPicker;
    @FXML
    private TextField duracionField;
    @FXML
    private ComboBox<String> duracionUnidadCombo;
    @FXML
    private ComboBox<String> estadoCombo;
    @FXML
    private CheckBox requiereInscripcionCheck;
    @FXML
    private TextField cupoMaximoField;
    @FXML
    private CheckBox esAbiertoCheck;
    @FXML
    ...
    @FXML
    private VBox tipoEspecificoContainer;
